...
<main>
    <div class="container-fluid">
        <h1 class="mt-4">Create To-do List</h1>
        ...
        <div class="card mb-4">
            <div class="card-body">
                @if(Session::has('todolists_create'))
                <div class="alert alert-primary alert-dismissible">
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                    <strong>Primary!</strong> {!! session('todolist_create') !!}
                </div>
                @endif
                @if (count($errors) > 0)
                <!-- Form Error List -->
                ...
                {!! Html::form('POST','/todolists')->acceptsFiles()->open() !!}
                ...
                {!! Html::select('status', ['pending' => 'Pending', 'completed' => 'Completed'], null)->class('form-control') !!}
                <br>
